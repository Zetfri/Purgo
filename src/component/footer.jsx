    ...
    return (
        <div>
            <div className='w-full h-[640px] bg-[#E3E3E3] pb-10 sm:w-full sm:h-auto'>
                <div className='w-[90%] h-full bg-[#292AFF] rounded-[30px] mx-auto flex sm:flex-col sm:w-[90%] '>
                    ...
                    <div className='w-[50%] mt-10 sm:w-[90%] sm:mx-auto sm:mb-10'>   
                            <iframe src="https://www.google.com/maps/@41.2862135,69.1768904,9z?entry=ttu" frameborder="0" width="600" height="500" className='rounded-[20px] sm:w-full '></iframe>
                    </div>
                </div>
            </div>
        </div>
