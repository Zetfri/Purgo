...
const Cards = () => {
    return (
        <div>
            <div className='w-full h-[1600px] pb-10 sm:mb-10 bg-[#E3E3E3] sm:w-full sm:h-auto sm:pb-10'>
                <div className='w-[90%] h-full bg-white mx-auto rounded-[30px]  flex sm:px-8 flex-wrap justify-center items-start py-10 sm:py-5 gap-12 sm:gap-8 sm:flex-col '>
